...
/**
 * logstore total course module viewed restore implementation
 *
...
class restore_logstore_total_course_module_viewed_subplugin extends restore_tool_log_logstore_subplugin {
    ...
    protected function define_logstore_subplugin_structure() {
        ...
        if (!in_array('logstore_total_course_module_viewed', $enabledlogstores)) {
        ...
        $elepath = $this->get_pathfor('/logstore_totalcoursemodview');
     ...
     */
    public function process_logstore_total_course_module_viewed_log($data) {
        global $DB;
        $contextrecord =
        ...
        $data['other'] = '';
        $data = $this->process_log($data, get_config('logstore_total_course_module_viewed', 'jsonformat'));
        if ($data) {
